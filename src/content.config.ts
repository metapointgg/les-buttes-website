...
const cottages = defineCollection({ loader: glob({ pattern: '**/*.{md,mdx}', base: './src/content/cottages' }), schema: z.object({
  ...
  heroImage:z.string(), heroAlt:z.string(), heroPan:z.boolean().optional(), gallery:z.array(z.object({image:z.string(),alt:z.string(),caption:z.string()})), facilities:z.array(z.string()),
...
const pages = defineCollection({ loader: glob({ pattern: '**/*.{md,mdx}', base: './src/content/pages' }), schema: z.object({
  title:z.string(), eyebrow:z.string(), intro:z.string(), heroImage:z.string().optional(), heroAlt:z.string().optional(), heroPan:z.boolean().optional(),
