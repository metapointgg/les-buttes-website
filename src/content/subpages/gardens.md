  ...
  - enabled: true
    ...
    items:
      ...
      - title: Sunken Garden
        ...
        image: /src/assets/images/garden-seating.png
        imageAlt: Sheltered seating among mature planting at Les Buttes
  - enabled: true
    type: gallery
    theme: paper
    width: wide
    eyebrow: Around the grounds
    title: Places to sit, wander and slow down
    text: A few views from the gardens and private outdoor spaces around Les Buttes.
    galleryImages:
      ...
      - image: /src/assets/images/cottages/honeysuckle/garden.jpg
        alt: Honeysuckle Cottage's private outdoor space
...
seo:
  ...
  description: Explore the gardens and grounds at Les Buttes Holiday Cottages, including the Main Garden, Veg Patch, Sunken Garden, Orchard and Valley.
---
