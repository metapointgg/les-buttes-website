...
sections:
  ...
  - enabled: true
    ...
    items:
      ...
      - title: Check availability
        text: Compare the cottages and continue to Airbnb for live dates and pricing.
        icon: external
  ...
  - enabled: true
    ...
    eyebrow: Location
    title: Find Les Buttes
    text: Les Buttes is on Rue des Raies in St Pierre du Bois, Guernsey.
  - enabled: true
    type: notice
    theme: cream
    width: narrow
    title: "Booking reassurance:"
