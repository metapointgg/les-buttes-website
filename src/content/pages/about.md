  ...
  - enabled: true
    ...
    items:
      ...
      - kicker: Since 1981
        ...
        text: The Ozanne family has welcomed self-catering guests for more than four decades.
      - kicker: Today
        title: A simple promise
        text: Comfortable cottages, practical help and freedom to discover Guernsey in your own time.
  - enabled: true
    type: cta
