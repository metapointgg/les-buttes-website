...
resource "aws_cloudfront_response_headers_policy" "security" {
  name = "les-buttes-security-headers"
...
resource "aws_cloudfront_distribution" "site" {
  ...
  lifecycle {
    precondition {
      condition     = !var.custom_domain_enabled || local.certificate_arn != null
      error_message = "When custom_domain_enabled is true, set hosted_zone_id or provide a validated us-east-1 certificate ARN."
    }
  }
