...
variable "custom_domain_enabled" { description="Use the custom domain and an ACM certificate instead of the temporary CloudFront URL" type=bool default=false }
